...
namespace Chimera.Overlay.Triggers {
    public class TextHoverTriggerFactory : ITriggerFactory {
        ...
        public ITrigger Create(XmlNode node, StateManager manager) {
            return new TextHoverTrigger(manager.Coordinator, node);
        }

        public ITrigger Create(XmlNode node, StateManager manager, Rectangle clip) {
            return new TextHoverTrigger(manager.Coordinator, node, clip);
        }
    }
    ...
    public class TextHoverTrigger : HoverTrigger, IDrawable {
        ...
        public TextHoverTrigger(Coordinator coordinator, XmlNode node)
        ...
        public TextHoverTrigger(Coordinator coordinator, XmlNode node, Rectangle clip)
