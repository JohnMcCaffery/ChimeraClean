...
namespace Chimera.Util {
    public static class ProcessWrangler {
        ...
        /// <summary>
        /// Sets a new extended coordinator style.
        /// </summary>
        ...
        /// <summary>
        /// Sets a new identifier of the child coordinator. The coordinator cannot be a top-level coordinator.
        /// </summary>
        private static readonly int GWL_ID = -12;
        /// <summary>
        /// Sets a new coordinator style.
        /// </summary>
        private static readonly int GWL_STYLE = -16;
        /// <summary>
        /// Sets the user data associated with the coordinator. This data is intended for use by the application that created the coordinator. Its value is initially zero.
        /// </summary>
        private static readonly int GWL_USERDATA = -21;
        /// <summary>
        /// Sets a new address for the coordinator procedure.  You cannot change this attribute if the coordinator does not belong to the same process as the calling thread.
        /// </summary>
        ...
        /// <summary>
        /// The coordinator accepts drag-drop files.
        /// </summary>
        private static readonly long WS_EX_ACCEPTFILES = 0x00000010L;
        /// <summary>
        /// Forces a top-level coordinator onto the taskbar when the coordinator is visible.
        /// </summary>
        private static readonly long WS_EX_APPWINDOW = 0x00040000L;
        /// <summary>
        /// The coordinator has a border with a sunken edge.
        /// </summary>
        private static readonly long WS_EX_CLIENTEDGE = 0x00000200L;
        /// <summary>
        /// Paints all descendants of a coordinator in bottom-to-top painting order using double-buffering. For more information, see Remarks. This cannot be used if the coordinator has a class style of either CS_OWNDC or CS_CLASSDC.
        /// Windows 2000:  This style is not supported.
        /// </summary>
        private static readonly long WS_EX_COMPOSITED = 0x02000000L;
        /// <summary>
        /// The title bar of the coordinator includes a question mark. When the user clicks the question mark, the cursor changes to a question mark with a pointer. If the user then clicks a child coordinator, the child receives a WM_HELP message. The child coordinator should pass the message to the parent coordinator procedure, which should call the WinHelp function using the HELP_WM_HELP command. The Help application displays a pop-up coordinator that typically contains help for the child coordinator.
        /// WS_EX_CONTEXTHELP cannot be used with the WS_MAXIMIZEBOX or WS_MINIMIZEBOX styles.
        /// </summary>
        private static readonly long WS_EX_CONTEXTHELP = 0x00000400L;
        /// <summary>
        /// The coordinator itself contains child windows that should take part in dialog box navigation. If this style is specified, the dialog manager recurses into children of this coordinator when performing navigation operations such as handling the TAB key, an arrow key, or a keyboard mnemonic.
        /// </summary>
        private static readonly long WS_EX_CONTROLPARENT = 0x00010000L;
        /// <summary>
        /// The coordinator has a double border; the coordinator can, optionally, be created with a title bar by specifying the WS_CAPTION style in the dwStyle parameter.
        /// </summary>
        private static readonly long WS_EX_DLGMODALFRAME = 0x00000001L;
        /// <summary>
        /// The coordinator is a layered coordinator. This style cannot be used if the coordinator has a class style of either CS_OWNDC or CS_CLASSDC.
        /// Windows 8:  The WS_EX_LAYERED style is supported for top-level windows and child windows. Previous Windows versions support WS_EX_LAYERED only for top-level windows.
        /// </summary>
        private static readonly long WS_EX_LAYERED = 0x00080000;
        /// <summary>
        /// If the shell language is Hebrew, Arabic, or another language that supports reading order alignment, the horizontal origin of the coordinator is on the right edge. Increasing horizontal values advance to the left.
        /// </summary>
        private static readonly long WS_EX_LAYOUTRTL = 0x00400000L;
        /// <summary>
        /// The coordinator has generic left-aligned properties. This is the default.
        /// </summary>
        ...
        /// <summary>
        /// The coordinator text is displayed using left-to-right reading-order properties. This is the default.
        /// </summary>
        private static readonly long WS_EX_LTRREADING = 0x00000000L;
        /// <summary>
        /// The coordinator is a MDI child coordinator.
        /// </summary>
        private static readonly long WS_EX_MDICHILD = 0x00000040L;
        /// <summary>
        /// A top-level coordinator created with this style does not become the foreground coordinator when the user clicks it. The system does not bring this coordinator to the foreground when the user minimizes or closes the foreground coordinator.
        /// To activate the coordinator, use the SetActiveWindow or SetForegroundWindow function.
        /// The coordinator does not appear on the taskbar by default. To force the coordinator to appear on the taskbar, use the WS_EX_APPWINDOW style.
        /// </summary>
        private static readonly long WS_EX_NOACTIVATE = 0x08000000L;
        /// <summary>
        /// The coordinator does not pass its coordinator layout to its child windows.
        /// </summary>
        private static readonly long WS_EX_NOINHERITLAYOUT = 0x00100000L;
        /// <summary>
        /// The child coordinator created with this style does not send the WM_PARENTNOTIFY message to its parent coordinator when it is created or destroyed.
        /// </summary>
        private static readonly long WS_EX_NOPARENTNOTIFY = 0x00000004L;
        /// <summary>
        /// The coordinator does not render to a redirection surface. This is for windows that do not have visible content or that use mechanisms other than surfaces to provide their visual.
        /// </summary>
        private static readonly long WS_EX_NOREDIRECTIONBITMAP = 0x00200000L;
        /// <summary>
        /// The coordinator is an overlapped coordinator.
        /// </summary>
        private static readonly long WS_EX_OVERLAPPEDWINDOW = (WS_EX_WINDOWEDGE | WS_EX_CLIENTEDGE);
        /// <summary>
        /// The coordinator is palette coordinator, which is a modeless dialog box that presents an array of commands.
        /// </summary>
        private static readonly long WS_EX_PALETTEWINDOW = (WS_EX_WINDOWEDGE | WS_EX_TOOLWINDOW | WS_EX_TOPMOST);
        /// <summary>
        /// The coordinator has generic "right-aligned" properties. This depends on the coordinator class. This style has an effect only if the shell language is Hebrew, Arabic, or another language that supports reading-order alignment; otherwise, the style is ignored.
        ...
        /// <summary>
        /// If the shell language is Hebrew, Arabic, or another language that supports reading-order alignment, the coordinator text is displayed using right-to-left reading-order properties. For other languages, the style is ignored.
        /// </summary>
        private static readonly long WS_EX_RTLREADING = 0x00002000L;
        /// <summary>
        /// The coordinator has a three-dimensional border style intended to be used for items that do not accept user input.
        /// </summary>
        private static readonly long WS_EX_STATICEDGE = 0x00020000L;
        /// <summary>
        /// The coordinator is intended to be used as a floating toolbar. A tool coordinator has a title bar that is shorter than a normal title bar, and the coordinator title is drawn using a smaller font. A tool coordinator does not appear in the taskbar or in the dialog that appears when the user presses ALT+TAB. If a tool coordinator has a system menu, its icon is not displayed on the title bar. However, you can display the system menu by right-clicking or by typing ALT+SPACE.
        /// </summary>
        private static readonly long WS_EX_TOOLWINDOW = 0x00000080L;
        /// <summary>
        /// The coordinator should be placed above all non-topmost windows and should stay above them, even when the coordinator is deactivated. To add or remove this style, use the SetWindowPos function.
        /// </summary>
        private static readonly long WS_EX_TOPMOST = 0x00000008L;
        /// <summary>
        /// The coordinator should not be painted until siblings beneath the coordinator (that were created by the same thread) have been painted. The coordinator appears transparent because the bits of underlying sibling windows have already been painted.
        /// To achieve transparency without these restrictions, use the SetWindowRgn function.
        /// </summary>
        private static readonly long WS_EX_TRANSPARENT = 0x00000020L;
        /// <summary>
        /// The coordinator has a border with a raised edge.
        /// </summary>
        private static readonly long WS_EX_WINDOWEDGE = 0x00000100L;

        // ---- SetWindowPos - uFlags
        /// <summary>
        /// If the calling thread and the thread that owns the coordinator are attached to different input queues, the system posts the request to the thread that owns the coordinator. This prevents the calling thread from blocking its execution while other threads process the request.
        /// </summary>
        ...
        /// <summary>
        /// Draws a frame (defined in the coordinator's class description) around the coordinator.
        /// </summary>
        private static readonly uint SWP_DRAWFRAME = 0x0020;
        /// <summary>
        /// Applies new frame styles set using the SetWindowLong function. Sends a WM_NCCALCSIZE message to the coordinator, even if the coordinator's size is not being changed. If this flag is not specified, WM_NCCALCSIZE is sent only when the coordinator's size is being changed.
        /// </summary>
        private static readonly uint SWP_FRAMECHANGED = 0x0020;
        /// <summary>
        /// Hides the coordinator.
        /// </summary>
        private static readonly uint SWP_HIDEWINDOW = 0x0080;
        /// <summary>
        /// Does not activate the coordinator. If this flag is not set, the coordinator is activated and moved to the top of either the topmost or non-topmost group (depending on the setting of the hWndInsertAfter parameter).
        /// </summary>
        private static readonly uint SWP_NOACTIVATE = 0x0010;
        /// <summary>
        /// Discards the entire contents of the client area. If this flag is not specified, the valid contents of the client area are saved and copied back into the client area after the coordinator is sized or repositioned.
        /// </summary>
        ...
        /// <summary>
        /// Does not change the owner coordinator's position in the Z order.
        /// </summary>
        private static readonly uint SWP_NOOWNERZORDER = 0x0200;
        /// <summary>
        /// Does not redraw changes. If this flag is set, no repainting of any kind occurs. This applies to the client area, the nonclient area (including the title bar and scroll bars), and any part of the parent coordinator uncovered as a result of the coordinator being moved. When this flag is set, the application must explicitly invalidate or redraw any parts of the coordinator and parent coordinator that need redrawing.
        /// </summary>
        ...
        /// <summary>
        /// Prevents the coordinator from receiving the WM_WINDOWPOSCHANGING message.
        /// </summary>
        ...
        // Get a handle to an application coordinator.
