...
namespace Joystick{
    public class JoystickPlugin : DeltaBasedPlugin {
        ...
        public override void Draw(Graphics graphics, Func<OSVector, Point> to2D, Action redraw, Perspective perspective) { }
