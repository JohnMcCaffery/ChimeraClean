...
namespace Chimera.Overlay {
    public class WindowOverlay {
        ...
        /// </summary>
        private ImageHoverTrigger mThumbnailSelectable;
        /// <summary>
        ...
        private void RecalculateThumbnail() {
            ...
            //mThumbnailSelectable = new ImageArea(mManager, mStaticBG, 1 - s, 0, 1, s);
            mThumbnailSelectable = new ImageHoverTrigger(mWindow, mStaticBG, 0f, 0f, 1f, s);
