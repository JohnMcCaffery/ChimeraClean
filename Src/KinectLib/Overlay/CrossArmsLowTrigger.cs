...
namespace Chimera.Kinect.Overlay {
    public class CrossArmsLowTriggerFactory : ITriggerFactory {
        ...
        public ITrigger Create(OverlayPlugin manager, System.Xml.XmlNode node) {
            return new CrossArmsLowTrigger(node);
        }
    ...
    public class CrossArmsLowTrigger : OverlayXmlLoader, ITrigger {
